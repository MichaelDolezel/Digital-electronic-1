...
1. See [schematic](f) or [reference manual]() of the Nexys A7 board and find out the connection of 7-segment displays, ie to which FPGA pins are connected and how.
