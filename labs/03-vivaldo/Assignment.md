...
2. Screenshot with simulated time waveforms. Always display all inputs and outputs (display the inputs at the top of the image, the outputs below them) at the appropriate time scale!
   ...
   ![https://github.com/MichaelDolezel/digital-electronic-1/blob/main/labs/03-vivaldo/images/Compar.png?raw=true](https://github.com/MichaelDolezel/digital-electronic-1/blob/main/labs/03-vivaldo/images/Compar.png?raw=true)
